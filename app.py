...
def predict():
        ...
        image_2 = face_recognition.load_image_file("dataset/kavya/kav (2).jpg")
        image_2_face_encoding = face_recognition.face_encodings(image_2)[0]

        image_3 = face_recognition.load_image_file("dataset/modi/modi (10).jpg")
        ...
        image_5 = face_recognition.load_image_file("dataset/yuvraj/yuvi (10).jpg")
        image_5_face_encoding = face_recognition.face_encodings(image_5)[0]
        
        image_6 = face_recognition.load_image_file("dataset/Arun/Arun(2).jpg")
        image_6_face_encoding = face_recognition.face_encodings(image_6)[0]

        image_7 = face_recognition.load_image_file("dataset/Sreeja/sreeja(2).jpg")
